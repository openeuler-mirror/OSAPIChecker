...
def get_platform_info():
    print("\033[1;30mStart APIChecker ---> LibChecker !!!\033[0m")
...
#    print(f_dict)
    print("\t\033[1;30mStandard Summary Info:\033[0m")
    print("\t\t\033[1:30mserial number: %s\033[0m" % f_dict['std_description']['std_number'])
    print("\t\t\033[1;30mfile name: %s\033[0m" % f_dict['std_description']['std_name'])

    print("\t\033[1;30mLibChecker Summary Info:\033[0m")
    print("\t\t\033[1;30mcheck location: %s\033[0m" % f_dict['libs']['lib_location'])
...
#    print("Enter function: libchecker_environment_init")
    ...
    g_counter_flags = {'pkg_counter': {'total': 0, 'passed': 0}, 'lib_counter': {'total': 0, 'passed': 0}}
...
#    p_srcpkgnam.close()
    ...
    g_counter_flags['pkg_counter']['total'] += 1

    print("\t\t\033[34mimplement package info:\033[0m ")

    if (len(srcpkgver) == 0):
        print("\t\t\t\t", "not found this package")
    else:
        print("\t\t\t\t\033[32msrc_pkgname\033[0m -> ", src_pkgname.ljust(20),"version -> ",srcpkgver)
        print("\t\t\033[34mshared libraries info:\033[0m")
        g_counter_flags['pkg_counter']['passed'] += 1
...
#    print(g_jsonfile_dict['libs']['category']['base']['packages'].keys())
    print("")
    print("\033[1;30mBeginning check at [",time.strftime("%Y-%m-%d %H:%M:%S",time.localtime()),"\033[0m]")
...
#    print('chapter:'.ljust(10),'name:'.ljust(20), 'level:'.ljust(5), 'version:'.ljust(5))
    ...
    for chapter_class in g_jsonfile_dict['libs']['category']:
       ...
       # for key in l_tmp_dict:
            print("\t\033[1;31mstart checking \033[0m", '<', "\033[1;30m", key,'>', "\033[0m")
            print("\t\t\033[31msections_number -->\033[0m", l_tmp_dict[key]['sections_number'])
#            print("\t\tlib_description -->", l_tmp_dict[key]['lib_description'])
            print("\t\t\033[31mnecessity       -->\033[0m", l_tmp_dict[key]['necessity']['desktop'])
            print("\t\t\033[34mstandand reference info:\033[0m")
            print("\t\t\t\t\033[36mstd_pkgname -> \033[0m" ,key.ljust(20),"version -> ", l_tmp_dict[key]['version']['desktop'].ljust(5))
            check_per_pkg_info(l_tmp_dict[key]['alias'][0]['name'])

            for list1_item in g_jsonfile_dict['libs']['category'][chapter_class]['packages'][key]['share_objs']['desktop']:
                print("\t\t\t\t\033[35mlib_soname -> \033[0m", "\033[31m",list1_item, "\033[0m")
                lib_result = check_sharelib_info('/lib', list1_item)
                print("\t\t\t\t\033[36mlib_locate -> \033[0m", "\033[33m",lib_result, "\033[0m")
...
#    check_per_so_info()
    ...
    print("=============================================================================================================")
    print("\033[1;30mEnd check at [",time.strftime("%Y-%m-%d %H:%M:%S",time.localtime()),"\033[0m]")
    print("\tPackage:")
    print("\t\t\033[1;30mTotal:\033[0m", g_counter_flags['pkg_counter']['total'], "|  \033[1;32mPassed:\033[0m", g_counter_flags['pkg_counter']['passed'], "| \033[1;31mFailed:\033[0m", g_counter_flags['pkg_counter']['total'] - g_counter_flags['pkg_counter']['passed'])
    print("\tLibrary:")
#    print("\t\t\ttotal:", g_counter_flags['lib_counter']['total'], "|  passed:", g_counter_flags['lib_counter']['passed'])
    print("\t\t\033[1;30mTotal:\033[0m", g_counter_flags['lib_counter']['total'], "|  \033[1;32mPassed:\033[0m", g_counter_flags['lib_counter']['passed'], "| \033[1;31mFailed:\033[0m", g_counter_flags['lib_counter']['total'] - g_counter_flags['lib_counter']['passed'])
    print("=============================================================================================================")
...
check_sharelib_info('/lib', 'libedit.so.2' )
